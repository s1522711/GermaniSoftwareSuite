...
Partial Class scamazon
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(scamazon))
        ...
        ' SuiteReturnBTN
        ' 
        SuiteReturnBTN.Location = New Point(12, 239)
