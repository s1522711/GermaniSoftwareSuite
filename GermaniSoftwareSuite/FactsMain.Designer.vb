...
Partial Class FactsMain
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(FactsMain))
        Button1 = New Button()
        ...
        MaximizeBox = False
        MaximumSize = New Size(558, 283)
        MinimumSize = New Size(508, 12)
        Name = "FactsMain"
